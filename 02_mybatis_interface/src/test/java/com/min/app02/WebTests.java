...
// import org.assertj.core.api.Assertions; -> import static org.assertj.core.api.Assertions.assertThat; 을 사용하면 클래스 이름 없이 메서드만 호출할 수 있어 코드가 간결해집니다.
...
public class WebTests {
  ...
  void 신규_등록_테스트() throws Exception {
    ...
    System.out.println(mvcResult.getModelAndView().getModelMap().toString());   // redirect 할 경로
    System.out.println(mvcResult.getFlashMap().get("msg"));                     // 실행결과 메세지
  }
